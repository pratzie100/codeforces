...
 
            ...
            else if(((i==1||i==n-2)&& j>0 && j<n-1) || ((j==1||j==n-2) && i>0 && i<n-1)) {
                 if(x=='X')  ans+=2;
            } 
 
            else if(((i==2 || i==n-3)  && j>1 && j<n-2) || ((j==2 || j==n-3) && i>1 && i<n-2)){
                 if(x=='X')  ans+=3;
            } 
            else if(((i==3||i==n-4) && j>2 && j<n-3) || ((j==3 || j== n-4) && i>2 && i<n-3)){
                 if(x=='X')  ans+=4;
            }     
            else if(((i==4 || i==n-5) && j>3 && j<n-4) || ((j==4|| j==n-5) && i>3 && i<n-4)) {
                 if(x=='X')  ans+=5;
            } 
 
        }
